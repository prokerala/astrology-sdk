...
final class PinnacleNumberTest extends BaseTestCase
{
    ...
    /**
     * @covers \Prokerala\Api\Numerology\Service\Pythagorean\PinnacleNumber::process
     */
    public function testProcess(): void
    {
        $service = new PinnacleNumber($this->getClient());

        $datetime = new \DateTimeImmutable();

        $result = $service->process($datetime);

        $this->assertInstanceOf(PinnacleResult::class, $result);
    }
}
