...
final class UniversalDayNumberTest extends BaseTestCase
{
    ...
    /**
     * @covers \Prokerala\Api\Numerology\Service\Pythagorean\UniversalDayNumber::process
     */
    public function testProcess(): void
    {
        $service = new UniversalDayNumber($this->getClient());
        ...
        $this->assertInstanceOf(UniversalDay::class, $result);
    }
}
