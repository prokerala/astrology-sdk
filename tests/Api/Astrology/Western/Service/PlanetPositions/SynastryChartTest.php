...
use Prokerala\Api\Astrology\Western\Service\PlanetPositions\SynastryChart;
use Prokerala\Test\Api\Common\Traits\AuthenticationTrait;
use Prokerala\Test\BaseTestCase;

/**
 * @internal
 * @covers \Prokerala\Api\Astrology\Western\Service\PlanetPositions\SynastryChart
 */
final class SynastryChartTest extends BaseTestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $this->assertInstanceOf(SynastryChartResult::class, $result);
    }
}
