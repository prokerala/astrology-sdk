 ...
 * @coversNothing
 */
final class ChoghadiyaTest extends BaseTestCase
{
    use AuthenticationTrait;

    /**
     * @covers \Prokerala\Api\Astrology\Service\Choghadiya::process
     */
    public function testProcess(): void
    {
        $service = new Choghadiya($this->getClient());
        ...
        $this->assertInstanceOf(ChoghadiyaResult::class, $result);
    }
}
