 ...
 * @coversNothing
 */
final class BirthDetailsTest extends BaseTestCase
{
    use AuthenticationTrait;

    /**
     * @covers \Prokerala\Api\Astrology\Service\BirthDetails::process
     */
    public function testProcess(): void
    {
        $service = new BirthDetails($this->getClient());
        ...
        $this->assertInstanceOf(NakshatraResult::class, $result);
    }
}
