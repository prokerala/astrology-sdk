 ...
 * @coversNothing
 */
final class PapaSamyamCheckTest extends BaseTestCase
{
    use AuthenticationTrait;

    /**
     * @covers \Prokerala\Api\Astrology\Service\PapaSamyamCheck::process
     */
    public function testProcess(): void
    {
        $service = new PapaSamyamCheck($this->getClient());
        ...
        $result = $service->process($girlProfile, $boyProfile, $la);

        $this->assertInstanceOf(PapaSamyamCheckResult::class, $result);
    }
}
