 ...
 * @coversNothing
 */
final class RituTest extends BaseTestCase
{
    use AuthenticationTrait;

    /**
     * @covers \Prokerala\Api\Astrology\Service\Ritu::process
     */
    public function testProcess(): void
    {
        $service = new Ritu($this->getClient());
        ...
        $this->assertInstanceOf(RituResult::class, $result);
    }
}
