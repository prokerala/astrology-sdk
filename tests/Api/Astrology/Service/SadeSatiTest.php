 ...
 * @coversNothing
 */
final class SadeSatiTest extends BaseTestCase
{
    use AuthenticationTrait;

    /**
     * @covers \Prokerala\Api\Astrology\Service\SadeSati::process
     */
    public function testProcess(): void
    {
        $service = new SadeSati($this->getClient());
        ...
        $this->assertInstanceOf(AdvancedSadeSatiResult::class, $result);
    }
}
