...
class NakshatraPorutham
{
     ...
     */
    public function __construct($maximumPoint, $obtainedPoint, Porutham $dinaPorutham, Porutham $ganaPorutham, Porutham $mahendraPorutham, Porutham $streeDhrirghamPorutham, Porutham $yoniPorutham, Porutham $rasiPorutham, Porutham $rasiLordPorutham, Porutham $rajjuPorutham, Porutham $vedaPorutham, Porutham $vashyaPorutham)
    {
